...
import Marquee from '@/components/3DTestimonials';
...
export default function DemoOne() {
  return (
    <div className="border-border rounded-2xl relative flex h-128 w-full flex-row items-center justify-center overflow-hidden gap-1.5 [perspective:250px]">
      <div
